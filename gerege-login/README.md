...
Гэрэгэ-гийн нэвтрэлтийн webapp — **Ory Hydra-гийн login/consent provider**
...
```bash
bash /tmp/gerege-e2e.sh    # эсвэл docs дахь жишээ скриптийг ашиглана
```
...
| UI | `resources/templates/*.html`, `resources/static/gerege.css` |
