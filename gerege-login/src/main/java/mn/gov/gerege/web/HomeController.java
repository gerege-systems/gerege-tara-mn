...
public class HomeController {
    ...
    public HomeController(
            @Value("${gerege.demo.issuer-public}") String issuerPublic,
            @Value("${gerege.demo.token-url}") String tokenUrl,
            @Value("${gerege.demo.client-id}") String clientId,
            @Value("${gerege.demo.client-secret}") String clientSecret,
            @Value("${gerege.demo.redirect-uri}") String redirectUri,
            ObjectMapper mapper) {
