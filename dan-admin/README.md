...
ДАН-гийн **үйлчилгээ (RP) бүртгэлийн портал** — үйлчилгээ эрхлэгчид
аппликейшнээ ДАН-нд бүртгэдэг UI (TARA-гийн "Liitumine" процессын дүйцэл).
...
Hydra admin хаягийг `DAN_HYDRA_ADMIN_URL` env-ээр тохируулна
