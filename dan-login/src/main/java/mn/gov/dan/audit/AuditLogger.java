 ...
 * Энд тусгай "dan.audit" logger-ээр бүтэцлэгдсэн мөр гаргана; production-д үүнийг
...
public class AuditLogger {
    ...
    private static final Logger audit = LoggerFactory.getLogger("dan.audit");
